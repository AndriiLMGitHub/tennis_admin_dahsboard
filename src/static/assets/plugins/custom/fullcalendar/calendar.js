/*
 * ---------------------------------------------------------------------------------------------------
 * READABILITY NOTES (added when reformatting this file for editing)
 * ---------------------------------------------------------------------------------------------------
 * This is the official FullCalendar v5.11.5 UMD bundle (core + interaction + dayGrid + timeGrid +
 * list + googleCalendar plugins + all locales), just run through Prettier for indentation/line breaks.
 * No logic, names, or behavior were changed -- verified by diffing the exported API surface against
 * the original minified file (same 247 exports, same version string, same locale count).
 *
 * Rough map of this file (search for "SECTION:" to jump between them):
 *   1. Polyfills / TS helpers (__extends, __assign, etc.)      -- top of file
 *   2. SECTION: Core Library                                   -- date math, mini vdom renderer,
 *                                                                  Calendar class, event system, views
 *   3. SECTION: Interaction Plugin                              -- click/drag/resize/drop
 *   4. SECTION: Day Grid Plugin                                 -- month view
 *   5. SECTION: Time Grid Plugin                                -- week/day hourly view
 *   6. SECTION: List Plugin                                     -- agenda/list view
 *   7. SECTION: Google Calendar Plugin
 *   8. SECTION: Locale / Translation Data                       -- ~78 languages, safe to trim
 *
 * Because this is a vendored third-party library, the recommended way to customize calendar behavior
 * is through FullCalendar's public options/callbacks (or CSS) in your own app code, rather than editing
 * internals here -- that way you can still upgrade FullCalendar versions later without losing changes.
 * ---------------------------------------------------------------------------------------------------
 */
...
var FullCalendar = (function (exports) {
  ...
  // Date/duration math, the mini virtual-DOM renderer, the Calendar class, event-source/event-store
  // handling, view base classes, and every option/hook that isn't specific to one plugin below.
  // ==================================================================================================
  ...
  function T$1(n) {
    ((!n.__d && (n.__d = !0) && r$1.push(n) && !$$1.__r++) || o !== l$1.debounceRendering) &&
  ...
  function I$1(n, l, u) {
    for (var i, t = n.__k, r = 0; t && r < t.length; r++)
      (i = t[r]) &&
        ((i.__ = n), (l = 'function' == typeof i.type ? I$1(i, l, u) : z$1(u, i, i, t, i.__e, l)));
    return l;
  }
  function j$2(n, l) {
    return (
  ...
  function rangeContainsMarker(range, date) {
    return (
      (range.start === null || date >= range.start) && (range.end === null || date < range.end)
    );
  }
  ...
  var PureComponent = /** @class */ (function (_super) {
    ...
    PureComponent.prototype.safeSetState = function (newState) {
      if (
        !compareObjs(this.state, __assign(__assign({}, this.state), newState), this.stateEquality)
      ) {
  ...
  // Adds dateClick, event dragging/resizing, and external drag-and-drop (draggable/droppable) support.
  // ==================================================================================================
  ...
  // ==================================================================================================
  // SECTION: Day Grid Plugin
  // Implements "dayGridMonth" / "dayGridWeek" / "dayGridDay" views (the classic month-grid layout).
  // ==================================================================================================
  ...
  // ==================================================================================================
  // SECTION: Time Grid Plugin
  // Implements "timeGridWeek" / "timeGridDay" views (the hour-by-hour grid).
  // ==================================================================================================
  ...
  // ==================================================================================================
  // SECTION: List Plugin
  // Implements the "listWeek" / "listMonth" / "listDay" agenda-style views.
  // ==================================================================================================
  ...
  // ==================================================================================================
  // SECTION: Google Calendar Plugin
  // Lets you point an event source at a public Google Calendar (via googleCalendarId / googleCalendarApiKey).
  // ==================================================================================================
  ...
  // ==================================================================================================
  // SECTION: Locale / Translation Data
  // Text strings (button labels, month/day names, "more" links, etc.) for ~78 languages.
  // Each block below is a self-contained IIFE that registers one locale into FullCalendar.globalLocales.
  // Safe to trim: delete the IIFE blocks for languages you don't ship to shrink this file a lot.
  // ==================================================================================================
[].push.apply(
